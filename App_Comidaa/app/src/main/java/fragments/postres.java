 ...
 */
public class postres extends Fragment implements ExampleAdapter.OnItemClickListener {
    ...
    private static final String URL="http://toxicosrest.000webhostapp.com/buscar_postre.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            exampleAdapter.setOnItemClickListener(postres.this);
